...
<body style="background-color: #EEEEEE">
	...
	<?php
		...
		?>
		<!-- Modal -->
		<div class="modal fade" id="tutorial" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content border-light shadow-sm">
					...
					<div class="modal-body">
						...
						<ul><li>Pelajari semua jawaban pada setiap pilihan</li><li>Pilih satu jawaban yang <strong>paling mendekati diri kamu</strong> (<i style="color:#56DB28" class="fas fa-thumbs-up"></i>)</li><li>Pilih satu jawaban yang <strong>paling tidak mendekati diri kamu</strong> (<i style="color:#E3451E" class="fas fa-thumbs-down"></i>)</li></ul><br>
						<p>Pada setiap soal harus memiliki jawaban <ins>satu</ins> <strong>paling mendekati diri kamu</strong> dan hanya <ins>satu</ins> <strong>paling tidak mendekati diri kamu</strong>.</p>
					...
					<div class="modal-footer">
						...
						<button type="button" id="mengerti" class="small px-2" disabled data-dismiss="modal">Mengerti</button>
					</div>
				</div>
			</div>
		</div>
	...
	if(!isset($_GET['id'])){ ?>
		<ul class="navbar nav ml-auto">
			...
			<li class="nav-item ml-3">
				<a style="font-size: 1.5em; cursor: help;" data-toggle="modal" data-target="#tutorial"><i class="fas fa-question-circle"></i></a>
			</li>
			<li class="nav-item ml-3">
