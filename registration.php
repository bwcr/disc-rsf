...
if(isset($_GET['id_mitra']) && isset($_GET['nama']) && isset($_GET['email'])){
	$id = FILTER_INPUT(INPUT_GET, 'id_mitra');
...
<body style="background-color: #EEEEEE" class="home page-template page-template-homepage-slider page-template-homepage-slider-php page page-id-93 logged-in admin-bar elementor-default p-0 elementor-page elementor-page-93 customize-support">
